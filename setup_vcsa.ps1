$VCSAHostname = "sa-vcsa-01.homelab.local"
$VCSAUsername = "administrator@vsphere.local"
$VCSAPassword = "VMware1!"
$DatacenterName = "HomeLab-DC"
$DatastoreName = "Z840-SATA-2TB-Datastore-1"
$ClusterName = "Tanzu-Cluster"
$ESXiHostname = "z840.homelab.local"
$ESXiPassword = "VMware1!"
$VDSName = "vds-HomeLab-Main"
$VDSManagementPG = "dpg-Mgmt-10.0.1.0"
$VDSFrontendPG = "dpg-Front-End-10.0.10.0"
$VDSWorkloadPG = "dpg-Workload-10.0.20.0"
